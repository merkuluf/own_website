...
const projects_list = [
    {
        title: 'Cash Count Bot',
        description:
            'Telegram bot that allows you to count how much money do you have, that distributed in different currencies.',
        image_path: images.currency_bot_jpeg,
        visit_link: 'https://t.me/CashCountBot',
        github_link: null,
    },
    // {
    //     title: 'Bit Rage VPN Bot',
    //     description:
    //         'Telegram bot that allows you to buy subscription to private VPN server.',
    ...
    // },
    {
        ...
        description:
            'This project contains server and client. Showcase of fullstack application.',
    ...
    },
    {
        ...
        description:
            'This project contains server and client. Showcase of fullstack application that uses websockets.',
    ...
    },
    {
        ...
        description:
            'Showcase of React Native application. Built following YouTube tutortial.',
